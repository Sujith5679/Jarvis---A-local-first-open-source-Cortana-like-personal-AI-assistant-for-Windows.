...
embedding model). Heavier on RAM/CPU and slower per-request than the Groq
backend, but needs no internet access and no API quota.
"""
...
logger = logging.getLogger("jarvis.voice.stt_local")
